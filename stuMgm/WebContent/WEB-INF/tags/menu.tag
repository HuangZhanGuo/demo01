		...
		<c:if test="${not empty isuser && isuser}">
			<ul>
				...
				<c:if test="${not empty isAdmin && isAdmin}">
					...
					<li><a class="menu-link" href="#">基本信息管理 |</a>
						<ul class="list">
							<li><a class="menu-link" href="studentAdmin.do">学生信息管理</a></li>
							<li><a class="menu-link" href="teacherAdmin.do">老师信息管理</a></li>
							<li><a class="menu-link" href="courseAdmin.do">课程管理</a></li>
						</ul>
					</li>
				</c:if> 
				<li class="one"><a class="menu-link" href="#">一览表 |</a>
			...
			<c:if test="${not empty isstudent && isstudent}">
				<ul>
					<li><a class="menu-link" href="studentlogin.do">学籍管理首页 |</a></li>
					<li class="two"><a class="menu-link" href="studentCourse.do?studentid=${user.getStuNumber()}">网上选课 |</a>
					</li>
					<li><a class="menu-link" href="studentCourse.do?flag=list&studentid=${user.getStuNumber()}">选课查看|</a></li>
